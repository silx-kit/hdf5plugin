...
* `H5Z-SPERR plugin <https://github.com/NCAR/H5Z-SPERR>`_ (v0.2.3)
  using `SPERR <https://github.com/NCAR/SPERR>`_ (v0.8.4).
* `SZ3 plugin <https://github.com/szcompressor/SZ3>`_ (v3.3.0)
