// $Id: jpegls_test.c 778 2016-03-09 07:56:29Z delaunay $
// =============================================================
//
// PROJECT : FCICOMP
//
...
static const char* JPEG_DECOMPRESS_SEGFAULT			= "jpeglsDecompressSegFault";
...
int main(int argc, char* argv[])
{
	...
	if (strcmp(testName, JPEG_DECOMPRESS_SEGFAULT) == 0) {
        // launch the test
		result = jpeglsDecompressSegFault(argc-1, argv+1);
    }
